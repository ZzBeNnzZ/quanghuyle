                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.skills.map((skill) => (
                      <Badge
                        key={skill}
                        className="bg-accent/95 hover:bg-accent/10 hover:text-accent hover:border-accent/30 transition-smooth px-4 py-2 text-sm"
                      >
                        {skill}
                      </Badge>
                    ))}
          ...
          <Card className="mt-8 p-8 shadow-elegant border-border/50 gradient-sapphire animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-blue-100 leading-relaxed max-w-2xl mx-auto">
                ...
                the latest technologies in software development, AI, and systems
                programming. Open to learning new tools and frameworks as needed
